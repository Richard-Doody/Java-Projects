	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 //Put in call to Java Time here
			 long startTime = System.nanoTime();
			 for (int i = 0; i<trials; i++) {
				BasicDocument testBD = new BasicDocument(testString);
				testBD.getFleschScore();
				 
			 }
			 long endTime = System.nanoTime();
			 double basicTime = (endTime-startTime)/1000000000.0;;
			// System.out.println(basicTime + "\t");
			 
			 long startTimeEfficient = System.nanoTime();
			 for (int i =0; i<trials; i++) {
				 EfficientDocument testED = new EfficientDocument(testString);
				 testED.getFleschScore();
			 }
			 long endTimeEfficient = System.nanoTime();
			 double efficientTime = (endTimeEfficient - startTimeEfficient)/1000000000.0;
