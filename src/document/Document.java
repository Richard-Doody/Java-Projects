...
public abstract class Document {
	...
	public double getFleschScore()
	{
	   ...
	   double numWordsF = (double)getNumWords();
	   double numSentencesF = (double)getNumSentences();
	   double numSyllablesF = (double)getNumSyllables();
		double fleschScore = 206.835 - (1.015*(numWordsF/numSentencesF)) - (84.6*(numSyllablesF/numWordsF));
		return fleschScore;
	}
